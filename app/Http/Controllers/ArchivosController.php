...
class ArchivosController extends Controller
{
  public function index(){
        ...
        */
        ...
        $license_code = "00655827-63E4-4338-8881-6A836FE2A322";
        $username = "IGNACIOESTEBAN";
	...
	*/
        ...
        //$url = 'http://www.ocrwebservice.com/restservices/processDocument?language=spanish&pagerange=1-5&outputformat=doc,txt';
        
        $url = 'http://www.ocrwebservice.com/restservices/processDocument?language=english&pagerange=1&gettext=true&outputformat=doc';
      

        // Full path to uploaded document
        $filePath ="../storage/app/public/res.pdf";
